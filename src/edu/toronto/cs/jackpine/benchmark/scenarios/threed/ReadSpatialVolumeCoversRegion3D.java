 ...
 * @author sray
 */
public class ReadSpatialVolumeCoversRegion3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialVolumeCoversRegion3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialVolumeCoversRegion3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectVolumeCoversRegion3D();
