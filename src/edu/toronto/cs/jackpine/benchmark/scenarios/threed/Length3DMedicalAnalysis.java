...
public class Length3DMedicalAnalysis extends SpatialScenarioBase {
    ...
    public Length3DMedicalAnalysis(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getLength3DMedicalAnalysisQuery();
