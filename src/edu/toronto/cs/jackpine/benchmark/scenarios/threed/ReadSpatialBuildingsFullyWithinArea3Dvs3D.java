...
public class ReadSpatialBuildingsFullyWithinArea3Dvs3D extends SpatialScenarioBase {
    ...
    public ReadSpatialBuildingsFullyWithinArea3Dvs3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getSelectBuildingFullyWithinArea3d();
