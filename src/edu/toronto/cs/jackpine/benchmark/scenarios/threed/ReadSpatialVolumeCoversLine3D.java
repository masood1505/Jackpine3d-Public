 ...
 * @author sray
 */
public class ReadSpatialVolumeCoversLine3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialVolumeCoversLine3D.class);
  ...
  public ReadSpatialVolumeCoversLine3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectVolumeCoversLine3D();
