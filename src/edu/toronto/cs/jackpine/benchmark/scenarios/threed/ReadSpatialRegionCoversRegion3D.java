 ...
 * @author sray
 */
public class ReadSpatialRegionCoversRegion3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialRegionCoversRegion3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialRegionCoversRegion3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectRegionCoversRegion3D();
