...
/**
 * A scenario for testing 3D spatial region contains region queries.
 * 
 * @version 1.0
 */
public class ReadSpatialRegionContainsRegion3D extends SpatialScenarioBase {
    private static final Logger logger = Logger.getLogger(ReadSpatialRegionContainsRegion3D.class);

    protected PreparedStatement[] pstmtArray;
    protected Connection conn;
    protected SpatialTableHelper3D helper3D;

    public ReadSpatialRegionContainsRegion3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getSelect3DRegionContainsRegion();
    ...
    public void iterate(long iterationCount) throws Exception {
        // Pick a statement at random on which to operate.
