...
public class ReadSpatialBuildingsLongestLineArea3Dvs3D extends SpatialScenarioBase {
    ...
    public ReadSpatialBuildingsLongestLineArea3Dvs3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getLongestLineAreaQuery();
