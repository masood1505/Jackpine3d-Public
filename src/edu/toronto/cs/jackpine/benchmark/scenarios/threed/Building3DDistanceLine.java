...
public class Building3DDistanceLine extends SpatialScenarioBase {
    ...
    public Building3DDistanceLine(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getBuilding3DDistanceLineQuery();
