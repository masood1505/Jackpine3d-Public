 ...
 * @author sray
 */
public class ReadSpatialVolumeContainsLine3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialVolumeContainsLine3D.class);
  ...
  public ReadSpatialVolumeContainsLine3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
    ...
    String sql = dialect.getSelectVolumeContainsLine3D();
