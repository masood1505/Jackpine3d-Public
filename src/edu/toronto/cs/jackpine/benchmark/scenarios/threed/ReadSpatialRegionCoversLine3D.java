 ...
 * @author sray
 */
public class ReadSpatialRegionCoversLine3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialRegionCoversLine3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialRegionCoversLine3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectRegionCoversLine3D();
