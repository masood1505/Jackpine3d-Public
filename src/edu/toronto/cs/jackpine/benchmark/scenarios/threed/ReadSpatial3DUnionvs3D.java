...
public class ReadSpatial3DUnionvs3D extends SpatialScenarioBase {

    private static final Logger logger = Logger.getLogger(ReadSpatial3DUnionvs3D.class);
    private PreparedStatement[] pstmtArray;
    private Connection conn;
    private SpatialTableHelper3D helper3D;

    public ReadSpatial3DUnionvs3D(Properties props) {
    ...
    private String getSelect3DUnion() {
        return "SELECT \n" +
               "    tr3d.fid AS california_id,\n" +  // Alias changed to california_id
