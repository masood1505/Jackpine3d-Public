...
public class DistanceWithin3D extends SpatialScenarioBase {
    private static final Logger logger = Logger.getLogger(DistanceWithin3D.class);
    ...
    public void iterate(long iterationCount) throws Exception {
        ...
        if (rs.next()) {
            logger.info("Within Distance (3D): " + rs.getBoolean("is_within_distance"));
        }
        rs.close();
    }
