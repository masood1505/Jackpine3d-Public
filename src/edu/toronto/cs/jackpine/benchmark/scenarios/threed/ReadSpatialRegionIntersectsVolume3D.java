 ...
 * @author sray
 */
public class ReadSpatialRegionIntersectsVolume3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialRegionIntersectsVolume3D.class);
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectRegionIntersectsVolume3D();
