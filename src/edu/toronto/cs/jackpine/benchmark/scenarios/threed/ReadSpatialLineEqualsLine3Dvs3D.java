...
public class ReadSpatialLineEqualsLine3Dvs3D extends SpatialScenarioBase {
    private static final Logger logger = Logger.getLogger(ReadSpatialLineEqualsLine3Dvs3D.class);
    private PreparedStatement[] pstmtArray;
    private Connection conn;
    private SpatialTableHelper3D helper3D;
    private boolean lastResult;

    public ReadSpatialLineEqualsLine3Dvs3D(Properties props) {
