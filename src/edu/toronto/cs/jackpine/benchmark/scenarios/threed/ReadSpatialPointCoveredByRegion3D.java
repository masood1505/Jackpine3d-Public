 ...
 * @author sray
 */
public class ReadSpatialPointCoveredByRegion3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialPointCoveredByRegion3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialPointCoveredByRegion3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectPointCoveredByRegion3D();
