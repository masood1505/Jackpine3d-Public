...
public class ReadSpatialLineOverlapsLine3D extends SpatialScenarioBase {
    ...
    public ReadSpatialLineOverlapsLine3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getSelectLineOverlapsLine3D();
