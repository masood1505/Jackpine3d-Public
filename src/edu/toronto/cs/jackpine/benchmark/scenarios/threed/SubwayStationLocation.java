...
public class SubwayStationLocation extends SpatialScenarioBase {
    ...
    public SubwayStationLocation(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getSubwayStationLocationQuery();
