...
public class ReadSpatialBuildingsIntersectionArea3Dvs3D extends SpatialScenarioBase {
    ...
    public ReadSpatialBuildingsIntersectionArea3Dvs3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getSelectBuildingIntersectionArea3Dvs3D();
