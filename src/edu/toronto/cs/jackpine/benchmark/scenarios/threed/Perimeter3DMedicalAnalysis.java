...
public class Perimeter3DMedicalAnalysis extends SpatialScenarioBase {
    ...
    public Perimeter3DMedicalAnalysis(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getPerimeter3DMedicalAnalysisQuery();
