...
public class Building3DDistanceWithinBuilding extends SpatialScenarioBase {
    ...
    public Building3DDistanceWithinBuilding(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getBuilding3DDistanceWithinBuildingQuery();
