 ...
 * @author sray
 */
public class ReadSpatialLineCoveredByVolume3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialLineCoveredByVolume3D.class);
  ...
  public ReadSpatialLineCoveredByVolume3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectLineCoveredByVolume3D();
