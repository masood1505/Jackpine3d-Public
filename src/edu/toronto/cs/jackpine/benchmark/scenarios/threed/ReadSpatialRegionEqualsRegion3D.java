...
/**
 * A scenario for testing 3D spatial region equals region queries.
 * 
 * @version 1.0
 */
public class ReadSpatialRegionEqualsRegion3D extends SpatialScenarioBase {
    private static final Logger logger = Logger.getLogger(ReadSpatialRegionEqualsRegion3D.class);
    ...
    public ReadSpatialRegionEqualsRegion3D(Properties properties) {
		// TODO Auto-generated constructor stub
	}*/
    /*
    public ReadSpatialRegionEqualsRegion3D() {
    ...
    public void prepare() throws Exception {
        ...
        String sql = "SELECT ST_Equals(a.geom, b.geom) AS regions_equal " +
    ...
    public void iterate(long iterationCount) throws Exception {
        ...
        try {
            ...
            if (rs.next()) {
                lastResult = rs.getBoolean("regions_equal");
                logger.info("Iteration " + iterationCount + ": 3D Regions Equal between " + id1 + " and " + id2 + ": " + lastResult);
            } else {
