...
public class CancerousAnalysisIntersection extends SpatialScenarioBase {
    ...
    public CancerousAnalysisIntersection(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getCancerousAnalysisIntersectionQuery();
