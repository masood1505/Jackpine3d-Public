...
public class Building3DIntersectsArea extends SpatialScenarioBase {
    ...
    public Building3DIntersectsArea(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getBuilding3DIntersectsAreaQuery();
