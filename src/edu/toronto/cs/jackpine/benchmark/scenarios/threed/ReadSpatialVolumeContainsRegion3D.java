 ...
 * @author sray
 */
public class ReadSpatialVolumeContainsRegion3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialVolumeContainsRegion3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialVolumeContainsRegion3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectVolumeContainsRegion3D();
