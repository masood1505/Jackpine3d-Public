 ...
 * @author sray
 */
public class ReadSpatialRegionCoveredByRegion3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialRegionCoveredByRegion3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialRegionCoveredByRegion3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectRegionCoveredByRegion3D();
