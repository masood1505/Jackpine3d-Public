 ...
 * @author sray
 */
public class ReadSpatialLineContainsVolume3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialLineContainsVolume3D.class);
  ...
  public ReadSpatialLineContainsVolume3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
    ...
    String sql = dialect.getSelectLineContainsVolume3D();
