 ...
 * @author sray
 */
public class ReadSpatialRegionCrossesVolume3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialRegionCrossesVolume3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialRegionCrossesVolume3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectRegionCrossesVolume3D();
