...
public class ReadSpatialBuildingsShortestLineArea3Dvs3D extends SpatialScenarioBase {
    ...
    public ReadSpatialBuildingsShortestLineArea3Dvs3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getShortestLineAreaQuery();
