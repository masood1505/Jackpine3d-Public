...
public class ReadSpatialBuildingsInterpolatepointArea3Dvs3D extends SpatialScenarioBase {
    ...
    public ReadSpatialBuildingsInterpolatepointArea3Dvs3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getLineInterpolatePointAreaQuery();
