 ...
 * @author sray
 */
public class ReadSpatialRegionCoveredByVolume3D extends SpatialScenarioBase
{
  private static final Logger logger = Logger.getLogger(ReadSpatialRegionCoveredByVolume3D.class);

  protected PreparedStatement[] pstmtArray;
  
  protected SpatialTableHelper3D helper3D;

  public ReadSpatialRegionCoveredByVolume3D(Properties props) {
  ...
  public void prepare() throws Exception
  {
      ...
      String sql = dialect.getSelectRegionCoveredByVolume3D();
