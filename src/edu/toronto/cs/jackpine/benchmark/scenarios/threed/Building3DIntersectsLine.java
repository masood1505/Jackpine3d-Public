...
public class Building3DIntersectsLine extends SpatialScenarioBase {
    ...
    public Building3DIntersectsLine(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getBuilding3DIntersectsLineQuery();
