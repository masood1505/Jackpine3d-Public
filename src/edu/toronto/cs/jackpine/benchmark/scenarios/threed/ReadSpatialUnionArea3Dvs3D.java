...
public class ReadSpatialUnionArea3Dvs3D extends SpatialScenarioBase {
    ...
    public ReadSpatialUnionArea3Dvs3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.get3DUnionSAreaQuery();
