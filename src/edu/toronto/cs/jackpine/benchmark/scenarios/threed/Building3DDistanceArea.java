...
public class Building3DDistanceArea extends SpatialScenarioBase {
    ...
    public Building3DDistanceArea(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getBuilding3DDistanceAreaQuery();
