...
public class ReadSpatial3DDistance3D extends SpatialScenarioBase {
    ...
    public ReadSpatial3DDistance3D(Properties props) {
    ...
    public void prepare() throws Exception {
        ...
        String sql = dialect.getSelect3DDistance3D();
